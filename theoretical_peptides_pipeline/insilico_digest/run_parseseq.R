...
###Read in csv file
seq_df <- read.csv("C:/Users/tobyl/OneDrive - The University of Manchester/Bioinformatics Masters/Research project 1/Git_repositories/RP1_m-z_speciesidentify/theoretical_peptides_pipeline/Sequences/sequences_taxon.csv", sep = ",")
...
mass_loop <- function(df){
  for (row in 1:nrow(df)){
    ...
    csv_name <- paste("C:/Users/tobyl/OneDrive - The University of Manchester/Bioinformatics Masters/Research project 1/Git_repositories/RP1_m-z_speciesidentify/theoretical_peptides_pipeline/insilico_digest/in_silico_res/"
                      , csv_name, ".csv", sep = "")
    print(csv_name)
