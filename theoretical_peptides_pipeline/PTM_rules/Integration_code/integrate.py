...
# and theoretical peptides from sequence from run_parseseq.R
...
# folder in_silico_res as csv files
...
def integrate(output_path):
    ...
    csv_files = glob.glob('C:/Users/tobyl/OneDrive - The University of Manchester/Bioinformatics Masters/Research project 1/Git_repositories/RP1_m-z_speciesidentify/theoretical_peptides_pipeline/insilico_digest/in_silico_res/*.csv')
