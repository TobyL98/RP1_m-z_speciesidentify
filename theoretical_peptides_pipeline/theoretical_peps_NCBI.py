...
parser.add_argument("-iA1", "--inputA1",
                    ...
                    default= 'Sequences/COL1A1_seqs_NCBI.fasta') # adds the input COL1A1 file
parser.add_argument("-iA2", "--inputA2",
                    ...
                    , default= 'Sequences/COL1A2_seqs_NCBI.fasta') # adds the input COL1A2 file
...
path2Script = 'C:/Users/tobyl/OneDrive - The University of Manchester/Bioinformatics Masters/Research project 1/Git_repositories/RP1_m-z_speciesidentify/theoretical_peptides_pipeline/insilico_digest/run_parseseq_NCBI.R'
