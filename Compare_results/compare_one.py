...
dtype = {"mass1": float}
theor_peaks_df = pd.read_csv("C:/Users/tobyl/OneDrive - The University of Manchester/Bioinformatics Masters/Research project 1/Git_repositories/RP1_m-z_speciesidentify/PTM_rules/Integration_code/integrate_results/Arvicanthis_niloticus_filtered.csv", 
                          sep = ",", dtype= dtype)
