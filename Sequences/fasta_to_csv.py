...
# reads in the fasta file (in this case combined COL1A1 and COL1A2 file)
...
file = 'COL1A1A2_combined_seqs.fasta'
sequences_df = readFastaFile(file)

sequences_df.to_csv('sequences_taxon.csv')
